...
const Cart = () => {
  ...
  return (
    <Container w="640px" bg={bgColor}  h={[480,550,550]}>
      ...
      <Flex justifyContent="space-between" px={["110px","40px","40px"]} marginLeft={['-70px','0','0']} w="560px">
        <HStack>
          <Image
            boxSize="100px"
            objectFit="cover"
          ...
          <Box textAlign="left" px={["5px",'15px',"15px"]} >
            <Text fontSize={["20px","24px","24px"]} fontWeight="700" color={secondaryTextColor} >
              Penny board
            </Text>
      ...
      <Box px='40px' marginRight="40px" w="560px" h="148px">
        ...
        <Flex justifyContent="space-between" my="16px">
          ...
          <Text color="#1A202C" fontSize="16px" fontWeight="700">
            $23.80
          </Text>
        </Flex>
